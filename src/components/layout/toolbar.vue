...
<template>
  <div>
    ...
    >
      <img
        src="@/assets/toolbar/hotpoint.png"
    ...
    >
      <img
        src="@/assets/toolbar/kongjian.png"
        style="width: 20px; height: 20px"
      />
...
import { layerSplit, removeLayerSplit } from "../CesiumLayersSplit.js";
import {
  lidarPlaneScan,
  lidarHemisphereScan,
  lidarPyramidScan,
    ...
    open(type) {
      switch (type) {
        ...
        case 3:
          ...
          break;
        case 4:
          Bus.$emit("nucleardensity-toolbar", true);
          break;
      }
    },
    open(type) {
